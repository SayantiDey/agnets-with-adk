...
This sample agent uses ADK (Agent Development Kit), a PostgreSQL support case database,google search and MCP Toolbox. 
...
This README contains instructions for local and Cloud Run deployment. 
